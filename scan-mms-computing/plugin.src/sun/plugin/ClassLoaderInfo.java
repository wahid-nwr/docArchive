...
public class ClassLoaderInfo
{
  ...
  public static synchronized void dumpClassLoaderCache(PrintStream paramPrintStream)
  {
    ...
    paramPrintStream.println(localStringBuffer.toString());
  }
  ...
  private static synchronized void addZombie(ClassLoaderInfo paramClassLoaderInfo)
  {
    ...
    {
      Trace.msgPrintln("classloaderinfo.caching", new Object[] { paramClassLoaderInfo });
      ...
      if (zombies.size() > zombieLimit)
      {
        ...
        Trace.msgPrintln("classloaderinfo.num", new Object[] { String.valueOf(zombieLimit), localClassLoaderInfo });
        zombies.remove(0);
        removeClassLoaderInfo(localClassLoaderInfo);
