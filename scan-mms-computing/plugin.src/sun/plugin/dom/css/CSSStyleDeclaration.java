  ...
  implements org.w3c.dom.css.CSSStyleDeclaration, CSS2Properties
{
  ...
  public CSSStyleDeclaration(DOMObject paramDOMObject, Document paramDocument, Node paramNode, CSSStyleSheet paramCSSStyleSheet, CSSRule paramCSSRule)
  {
  ...
  {
    throw new PluginNotSupportedException("CSSStyleDeclaration.getPropertyCSSValue() is not supported.");
  }

  public String removeProperty(String paramString)
    throws DOMException
  {
    throw new PluginNotSupportedException("CSSStyleDeclaration.removeProperty() is not supported.");
  }

  public String getPropertyPriority(String paramString)
  {
    throw new PluginNotSupportedException("CSSStyleDeclaration.getPropertyPriority() is not supported.");
  }
  ...
  {
    throw new PluginNotSupportedException("CSSStyleDeclaration.getLength() is not supported.");
  }

  public String item(int paramInt)
  {
    throw new PluginNotSupportedException("CSSStyleDeclaration.item() is not supported.");
  }
