  ...
  public static boolean updateCache()
  {
    ...
    try
    {
      ...
      while (localListIterator.hasNext())
      {
        ...
        try
        {
          Cache.insertFile(localOldCacheEntry.getDataFile(), 0, localOldCacheEntry.getURL(), localOldCacheEntry.getVersion(), localOldCacheEntry.getLastModified(), localOldCacheEntry.getExpiration());
        }
